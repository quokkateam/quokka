				...
				<div className="container-fluid">
					<div className="row">
						<div className="col-md-4 col-sm-12 col-xs-12 about-category" id="challenges">
							<img className="icon" src="https://s3-us-west-1.amazonaws.com/quokkadev/marketing/images/evidence.png" />
						...
						<div className="col-md-4 col-sm-12 col-xs-12 about-category" id="prizes">
							<img className="icon" src="https://s3-us-west-1.amazonaws.com/quokkadev/marketing/images/gift.png" />
						...
						<div className="col-md-4 col-sm-12 col-xs-12 about-category" id="community">
							<img className="icon" src="https://s3-us-west-1.amazonaws.com/quokkadev/marketing/images/community.png" />
